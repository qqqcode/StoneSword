...
#include "StoneSword/Events/KeyEvent.h"
#include "StoneSword/Events/ApplicationEvent.h"
#include "StoneSword/Events/MouseEvent.h"
...
namespace StoneSword 
{
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		SS_CORE_ASSERT(status,"Faild to initialize Glad");
